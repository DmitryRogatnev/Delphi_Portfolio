object Frame_Tp_TechProc_DocDetList: TFrame_Tp_TechProc_DocDetList
  Left = 0
  Top = 0
  Width = 1142
  Height = 726
        ...
        object Grid_Time_Norms: TDBVertGridEh
          ...
          Rows = <
            ...
            item
              ...
              RowLabel.Caption = #1058' '#1086#1073#1089'.+'#1058' '#1086#1090#1083'., '#1095
              CategoryName = 'Time_Norm'
              OnUpdateData = Grid_Time_NormsTimeRowsUpdateData
            end
            item
  ...
  object Pm_Print: TPopupMenu
    ...
    Left = 280
    Top = 166
    object Pm_Print_Btn_List: TMenuItem
      Caption = #1042#1077#1076#1086#1084#1086#1089#1090#1100' '#1076#1077#1090#1072#1083#1077#1081
      object Pm_Print_Btn_List_See: TMenuItem
        Caption = #1055#1088#1086#1089#1084#1086#1090#1088
        ImageIndex = 44
      end
      object Pm_Print_Btn_List_Export: TMenuItem
        Caption = #1069#1082#1089#1087#1086#1088#1090
        object Pm_Print_Btn_List_Export_PDF: TMenuItem
          Caption = 'PDF'
          ImageIndex = 46
          OnClick = Pm_Print_Btn_List_Export_PDFClick
        end
        object Pm_Print_Btn_List_Export_Excel: TMenuItem
          Caption = 'Excel'
          ImageIndex = 47
          OnClick = Pm_Print_Btn_List_Export_ExcelClick
        end
      end
    end
    object Pm_Print_Btn_TechProc: TMenuItem
      Caption = #1058#1077#1093#1087#1088#1086#1094#1077#1089#1089' '#1076#1083#1103' '#1076#1077#1090#1072#1083#1080
      object Pm_Print_Btn_TechProc_See: TMenuItem
        Caption = #1055#1088#1086#1089#1084#1086#1090#1088
        ImageIndex = 44
        OnClick = Pm_Print_Btn_TechProc_SeeClick
      end
      object Pm_Print_Btn_TechProc_Export: TMenuItem
        Caption = #1069#1082#1089#1087#1086#1088#1090
        object Pm_Print_Btn_TechProc_Export_PDF: TMenuItem
          Caption = 'PDF'
          ImageIndex = 46
          OnClick = Pm_Print_Btn_TechProc_Export_PDFClick
        end
        object Pm_Print_Btn_TechProc_Export_Excel: TMenuItem
          Caption = 'Excel'
          ImageIndex = 47
          OnClick = Pm_Print_Btn_TechProc_Export_ExcelClick
        end
      end
    end
  end
  object ActionList1: TActionList
    ...
    object Act_CopyDoc: TAction
      Category = 'DocActions'
      Caption = #1057#1092#1086#1088#1084#1080#1088#1086#1074#1072#1090#1100' '#1074#1077#1076#1086#1084#1086#1089#1090#1100' '#1080#1079' '#1093#1080#1084'. '#1087#1086#1082#1088#1099#1090#1080#1081
      Hint = #1057#1092#1086#1088#1084#1080#1088#1086#1074#1072#1090#1100' '#1074#1077#1076#1086#1084#1086#1089#1090#1100' '#1080#1079' '#1093#1080#1084'. '#1087#1086#1082#1088#1099#1090#1080#1081
      ImageIndex = 25
