unit Tp_TechProc_DocDetListFrame;
...
uses
  ...
  Vcl.Menus, Vcl.ComCtrls, DBVertGridsEh, Vcl.StdCtrls, Vcl.Mask, DBCtrlsEh,
  EhLibVCL, GridsEh, DBAxisGridsEh, DBGridEh, Vcl.ExtCtrls, MemTableDataEh,
  DataDriverEh, MemTableEh, Tp_TechProc_DocDetListDataFrame, System.Actions,
  Vcl.ActnList, Vcl.ToolWin;

type
  TFrame_Tp_TechProc_DocDetList = class(TFrame)
    Splitter1: TSplitter;
    ...
    Pm_Print: TPopupMenu;
    Pm_Print_Btn_List: TMenuItem;
    Pm_Print_Btn_List_Export: TMenuItem;
    Pm_Print_Btn_List_Export_Excel: TMenuItem;
    Pm_Print_Btn_List_Export_PDF: TMenuItem;
    Pm_Print_Btn_List_See: TMenuItem;
    Pm_Print_Btn_TechProc: TMenuItem;
    Pm_Print_Btn_TechProc_Export: TMenuItem;
    Pm_Print_Btn_TechProc_Export_Excel: TMenuItem;
    Pm_Print_Btn_TechProc_Export_PDF: TMenuItem;
    Pm_Print_Btn_TechProc_See: TMenuItem;
    ...
    procedure DBGrid_OperationsGetCellParams(Sender: TObject; Column: TColumnEh;
      AFont: TFont; var Background: TColor; State: TGridDrawState);
    procedure Pm_Print_Btn_List_Export_PDFClick(Sender: TObject);
    procedure Pm_Print_Btn_List_Export_ExcelClick(Sender: TObject);
    procedure Pm_Print_Btn_TechProc_SeeClick(Sender: TObject);
    procedure Pm_Print_Btn_TechProc_Export_PDFClick(Sender: TObject);
    procedure Pm_Print_Btn_TechProc_Export_ExcelClick(Sender: TObject);
    ...
    procedure Tb_SignDocClick(Sender: TObject);
  ...
  public
    ...
    TechProcDataFrame: TFrame_Tp_TechProc_DocDetListData;
    ...
    Procedure P_Open_ListTechProc;
    function F_Save_ListTechProc(Sender: TObject): Integer;
...
uses
Tp_Main_Form, Udm_Main, Tp_Data_Mode, Gen_Chs_Dd_Form,
  Tp_Detail_Docs_Connect_Form, Tp_Setup_Time_Calc,
  Tp_Copy_Detail_For_Det_Doc_Form, Tp_Copy_Oper_For_Det_Doc_Form;

procedure TFrame_Tp_TechProc_DocDetList.GridExit(Sender: TObject);
begin
  try (Sender as TDBGridEh).DataSource.DataSet.Post
  except end;
end;

procedure TFrame_Tp_TechProc_DocDetList.DBGrid_DetailsGetCellParams(
...
procedure TFrame_Tp_TechProc_DocDetList.DBGrid_DocsColumns6OpenDropDownForm(
...
procedure TFrame_Tp_TechProc_DocDetList.DBGrid_OperationsGetCellParams(
  Sender: TObject; Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Act_CopyDocExecute(Sender: TObject);
var
  I: Integer;
  ButtonSelected: Integer;
  Oper_Count: Integer;
Begin
  If Not TechProcDataFrame.Db_Doc_Info.FieldByName('IZD_ID').IsNull
  Then
  Begin
    ...
    Begin
      ...
      TechProcDataFrame.PKG_TP_DOC.CallProcedure( 'P_Copy_Det_Opers_From_Chem', [ TechProcDataFrame.Db_Doc_Info.FieldByName('MAIN_DOC_ID').AsString,
                                                                TechProcDataFrame.Db_Doc_Info.FieldByName('IZD_ID').AsString ] );
...
procedure TFrame_Tp_TechProc_DocDetList.Act_PrintDocExecute(Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
...
procedure TFrame_Tp_TechProc_DocDetList.Act_SaveDocExecute(Sender: TObject);
begin
  F_Save_ListTechProc(Tb_Save);
end;

procedure TFrame_Tp_TechProc_DocDetList.Act_SingDocExecute(Sender: TObject);
begin
  Form_Tech_Proc_Main.P_Approve_Doc(Nil, FDocHeaderId);
end;

procedure TFrame_Tp_TechProc_DocDetList.Btn_CopyClick(Sender: TObject);
var
  I: Integer;
  ButtonSelected: Integer;
  Oper_Count: Integer;
...
procedure TFrame_Tp_TechProc_DocDetList.Btn_DeleteNormClick(Sender: TObject);
begin
  Grid_Time_Norms.DataSource.DataSet.Delete;
end;

procedure TFrame_Tp_TechProc_DocDetList.Btn_Hide_Det_ParamsClick(Sender: TObject);
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Change_Doc_Edit(v_Param: String);
begin
...
constructor TFrame_Tp_TechProc_DocDetList.Create(AOwner: TComponent; InDocHeaderId: Integer);
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Det_Export_ExcelClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
  v_In_Params := TDynVarsEh.Create( Application.MainForm );
  v_In_Params.DynVar[ 'Doc_Header_Id' ].AsInteger := TechProcDataFrame.Db_Doc_Info.FieldByName('Main_Doc_Header_Id').AsInteger;
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Det_Export_PdfClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
  v_In_Params := TDynVarsEh.Create( Application.MainForm );
  v_In_Params.DynVar[ 'Doc_Header_Id' ].AsString := TechProcDataFrame.Db_Doc_Info.FieldByName('Main_Doc_Header_Id').AsString;
  v_In_Params.DynVar[ 'In_Id_Row_Det' ].AsInteger := DBGrid_Details.DataSource.DataSet.FieldByName('Id').AsInteger;
  v_In_Params.DynVar[ 'Format' ].AsString := 'Document_For_Det';
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Det_SeeClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Vtp_Export_ExcelClick(Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
  v_In_Params := TDynVarsEh.Create( Application.MainForm );
  v_In_Params.DynVar[ 'Doc_Header_Id' ].AsInteger := TechProcDataFrame.Db_Doc_Info.FieldByName('Doc_Header_Id').AsInteger;
  v_In_Params.DynVar[ 'Format' ].AsString := 'Document';
  v_In_Params.DynVar[ 'Action' ].AsString := 'Export_In_Excel';
  Tp_Main_Form.Form_Tech_Proc_Main.P_Report_Tech_Process( v_In_Params, Nil );
end;

procedure TFrame_Tp_TechProc_DocDetList.E_Oper_PrimDblClick(Sender: TObject);
  var
...
procedure TFrame_Tp_TechProc_DocDetList.FormCloseQuery(Sender: TObject;
...
procedure TFrame_Tp_TechProc_DocDetList.FormCreate(Sender: TObject);
begin
  Btn_Hide_Det_ParamsClick(Btn_Hide_Det_Params);
  StrList_GlobalVars := TStringListEh.Create;
end;

procedure TFrame_Tp_TechProc_DocDetList.FormResize(Sender: TObject);
Var
...
function TFrame_Tp_TechProc_DocDetList.F_Save_ListTechProc(
...
var
  ...
  Begin
    ...
    For i := 0 to Length(TechProcDataFrame.Arr_DataSetsSaveLine)-1
    Do
    Begin
      If TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsSaveLine[i]) Is TMemTableEh
      Then
      Begin
        EnMemTable := (TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsSaveLine[i]) as TMemTableEh);
        With EnMemTable
        Do
        Begin
          if Action = 'Save'
        ...
        End;
      End
      Else If TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsSaveLine[i]) Is TOracleDataSet
      Then
      Begin
        EnOracleDataSet := (TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsSaveLine[i]) as TOracleDataSet);
    ...
    Begin
      DM_Main.Session.ApplyUpdates(ArrDataSet,
                                   True);
      For i := 0 to Length(TechProcDataFrame.Arr_DataSetsOpenLine)-1
      Do
      Begin
        If TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsOpenLine[i][0]) Is TMemTableEh
        Then
        Begin
          With (TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsOpenLine[i][0]) as TMemTableEh)
          Do
          Begin
            Close;
            If TechProcDataFrame.Arr_DataSetsOpenLine[i][1] <> ''
            Then
            Begin
              if StrList_GlobalVars.IndexOfName(TechProcDataFrame.Arr_DataSetsOpenLine[i][1]) <> -1
              Then
               ((DataDriver as TDataSetDriverEh).ProviderDataSet as TOracleDataSet).SetVariable( TechProcDataFrame.Arr_DataSetsOpenLine[i][1],
                                                                                                 StrList_GlobalVars.Values[TechProcDataFrame.Arr_DataSetsOpenLine[i][1]]);
            End;
            Open;
          End;
        End
        Else If TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsOpenLine[i][0]) Is TOracleDataSet
        Then
        Begin
          With (TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsOpenLine[i][0]) as TOracleDataSet)
          Do
          Begin
            Close;
            If TechProcDataFrame.Arr_DataSetsOpenLine[i][1] <> ''
            ...
            Begin
              if StrList_GlobalVars.IndexOfName(TechProcDataFrame.Arr_DataSetsOpenLine[i][1]) <> -1
              Then
                SetVariable(TechProcDataFrame.Arr_DataSetsOpenLine[i][1],
                            StrList_GlobalVars.Values[TechProcDataFrame.Arr_DataSetsOpenLine[i][1]]);
            End;
            Open;
          End;
...
begin
  Try
    ...
    Do
    Begin
      With TechProcDataFrame.FindComponent(TechProcDataFrame.Arr_DataSetsSaveLine[i]) as TDataSet
      Do
        Try Post Except End;
    End;
...
procedure TFrame_Tp_TechProc_DocDetList.Grid_Time_NormsTimeRowsUpdateData(
...
procedure TFrame_Tp_TechProc_DocDetList.Grid_Time_NormsAdvDrawDataCell(
...
procedure TFrame_Tp_TechProc_DocDetList.Grid_Time_NormsRows5EditButtons0Click(
...
procedure TFrame_Tp_TechProc_DocDetList.Grid_Time_NormsRows6UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);Var
    V_In_Params, v_Det_Trud_Out_Params, v_Out_Params: TDynVarsEh;
    Vl_In_Det_Params, Vl_Out_Det_Params: TDynVarsEh;
...
procedure TFrame_Tp_TechProc_DocDetList.Pm_Print_Btn_List_Export_ExcelClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pm_Print_Btn_List_Export_PDFClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pm_Print_Btn_TechProc_Export_ExcelClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pm_Print_Btn_TechProc_Export_PDFClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pm_Print_Btn_TechProc_SeeClick(
  Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Detail_Docs_Btn_VTP_Cancel_DocClick(Sender: TObject);
Var
  v_Izd_Id: Integer;
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Opers_ParamsClick(Sender: TObject);
begin
  Btn_Hide_Det_ParamsClick( Btn_Hide_Oper_Params );
end;

procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Oper_TimeClick(
  Sender: TObject);
begin
  ...
  begin
    try
      ListTechProc_DataFrame := Self.TechProcDataFrame;
      ShowModal;
      Try Self.DBGrid_Operations.DataSource.DataSet.Post Except End;
      Try Self.Grid_Time_Norms.DataSource.DataSet.Post Except End;
    finally
      Free;
    end;
  end;
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Paste_OpersClick(
  Sender: TObject);
  Var
  I, Rec_Num: Integer;
  Vl_Text: String;
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Doc_Details_Btn_Det_ParamsClick(Sender: TObject);
begin
  Btn_Hide_Det_ParamsClick( Btn_Hide_Det_Params );
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Copy_OpersClick(Sender: TObject);
Var
...
begin
  ...
  Begin
    ...
    Vl_Btn_Slct := 0;
    If (Tp_Main_Form.Form_Tech_Proc_Main.User_Admin)
        Or ((TechProcDataFrame.Pkg_Tp_Doc.CallIntegerFunction( 'F_Find_User_In_Dep_Mmbr', [ Udm_Main.DM_Main.Session.LogonUsername, 201 ] ) = 1)
            And (TechProcDataFrame.Pkg_Tp_Doc.CallIntegerFunction( 'F_Find_User_In_Dep_Mmbr', [ Udm_Main.DM_Main.Session.LogonUsername, 202 ] ) = 1))
    Then
    Begin
    ...
    If (TechProcDataFrame.Pkg_Tp_Doc.CallIntegerFunction( 'F_Find_User_In_Dep_Mmbr', [ Udm_Main.DM_Main.Session.LogonUsername, 201 ] ) = 1)
        Or ( Vl_Btn_Slct = mrYes)
    Then
    Begin
      ...
      End;
    End
    Else if  (TechProcDataFrame.Pkg_Tp_Doc.CallIntegerFunction( 'F_Find_User_In_Dep_Mmbr', [ Udm_Main.DM_Main.Session.LogonUsername, 202 ] ) = 1)
              Or ( Vl_Btn_Slct = mrNo)
    Then
    Begin
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Copy_Opers_From_Chem_CoverClick(Sender: TObject);
var
  I: Integer;
  ButtonSelected: Integer;
  Oper_Count: Integer;
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_ExitClick(Sender: TObject);
begin
  Form_Tp_Connected_Details.Close;
end;

procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Doc_Details_Btn_Add_DetClick(Sender: TObject);
var
  I: Integer;
begin
  with TechProcDataFrame
  ...
  begin
    ...
    Begin
      ...
      with TForm_Copy_Det_From_Rcd.Create(Self)
      do
      begin
        try
          Grid_Details.DataSource := Self.TechProcDataFrame.Data_Details_For_Copy;
          If ShowModal = mrOk
          Then
          Begin
            ...
            Then
            Begin
              Self.TechProcDataFrame.MemT_Doc_Details.First;
              For I := 1 to Self.TechProcDataFrame.MemT_Doc_Details.RecordCount
              Do
              Begin
                Self.TechProcDataFrame.MemT_Doc_Details.Delete;
                Self.TechProcDataFrame.MemT_Doc_Details.Next;
              End;
            End;
            Self.TechProcDataFrame.MemT_Details_For_Copy.First;
            ...
            Begin
              ...
              Then
              Begin
                Self.TechProcDataFrame.MemT_Doc_Details.Append;
                Self.TechProcDataFrame.MemT_Doc_Details.CopyFields( MemT_Details_For_Copy );
                Self.TechProcDataFrame.MemT_Doc_Details.Post;
              End;
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Doc_Details_Btn_DeleteClick(Sender: TObject);
begin
  Tp_Main_Form.Form_Tech_Proc_Main.P_DeleteFromDBGridEh( DBGrid_Details );
end;

procedure TFrame_Tp_TechProc_DocDetList.MemT_Doc_DetailsAfterPost(
  DataSet: TDataSet);
begin
...
procedure TFrame_Tp_TechProc_DocDetList.MemT_Doc_DetailsBeforeDelete(
  DataSet: TDataSet);
begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Add_OpersClick(Sender: TObject);
var
  I: Integer;
begin
  with TechProcDataFrame
  ...
  begin
    ...
    Begin
      ...
      with TForm_Copy_Opers_From_TTP.Create(Self)
      do
      begin
        Try
          Grid_Operations.DataSource := Self.TechProcDataFrame.Data_Operations_For_Copy;
          If ShowModal = mrOK
          Then
          Begin
            Try
              MemT_Detail_Operations.DisableControls;
              If COPY_1_Check.Checked
              Then
              Begin
                MemT_Detail_Operations.First;
                For I := 1 To MemT_Detail_Operations.RecordCount
                Do
                Begin
                  MemT_Detail_Operations.Delete;
                  MemT_Detail_Operations.Next;
                End;
              End;

              With Grid_Operations
              Do
              Begin
                ...
                Begin
                  ...
                  Then
                    Break;
                  MemT_Detail_Operations.Append;
                  MemT_Detail_Operations.CopyFields( MemT_Operations_For_Copy );
                  MemT_Detail_Operations.Post;
                End;
                Selection.Clear;
              End;
            Finally
              MemT_Detail_Operations.EnableControls;
            End;
          End;
        Finally
          Free;
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Operations_Btn_Delete_OpersClick(Sender: TObject);
begin
  Tp_Main_Form.Form_Tech_Proc_Main.P_DeleteFromDBGridEh( DBGrid_Operations );
end;

procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Vtp_SeeClick(Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
...
procedure TFrame_Tp_TechProc_DocDetList.Main_M_Tp_Connected_Details_Btn_Doc_Vtp_Export_PDFClick(Sender: TObject);
  var
  v_In_Params: TDynVarsEh;
begin
  F_Save_ListTechProc(Tb_Print);
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_Doc_DetailsPopup(Sender: TObject);
begin
  if Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
...
procedure TFrame_Tp_TechProc_DocDetList.Pop_M_OperationsPopup(Sender: TObject);
begin
//  if Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
//  Then
//  Begin
...
procedure TFrame_Tp_TechProc_DocDetList.P_Open_ListTechProc;
 var
  v_In_Doc_Params,
...
begin
  ...
  Do
  Begin
    DBGrid_Details.DataSource := Data_Doc_Details;
    VGrid_Det_Params.DataSource := Data_Doc_Details;
    DBGrid_Operations.DataSource := Data_Detail_Operations;
    VGrid_Oper_Params.DataSource := Data_Detail_Operations;
    VGrid_Oper_Params.FieldRows['TIME_EDIZM_NAME'].LookupParams.LookupDataSet := Db_Time_Edizm;
    VGrid_Oper_Params.FieldRows['OPER_CHS_PARAMS'].LookupParams.LookupDataSet := Db_Chosen_Params;
    VGrid_Oper_Params.FieldRows['COLOR_NAME'].LookupParams.LookupDataSet := Db_Colors;
    E_OPER_AUTHOR_NAME.DataSource := Data_Detail_Operations;
    E_OPER_DATA_CHANGE.DataSource := Data_Detail_Operations;
    E_Oper_Prim.DataSource := Data_Detail_Operations;
...
Procedure TFrame_Tp_TechProc_DocDetList.P_Set_Flag_InDBGridEh(DBGridEh: TDBGridEh; V_Flag: Integer);
Var
  i: Integer;
...
procedure TFrame_Tp_TechProc_DocDetList.Tb_SignDocClick(Sender: TObject);
begin
  Form_Tech_Proc_Main.P_Approve_Doc(Nil, FDocHeaderId);
end;

procedure TFrame_Tp_TechProc_DocDetList.VGrid_Det_ParamsRows0EditButtons0Click(
  Sender: TObject; var Handled: Boolean);
  var
   V_In_Mat_Params,
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Det_ParamsRows0UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
  var
   V_In_Mat_Params,
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Det_ParamsRows1UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
  Var
    V_In_Params,
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows0UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
  Var
    V_In_Params,
...
begin
  ...
  Begin
    ...
    Begin
      ...
      v_In_Params.DynVar[ 'Filter' ].AsString := ' Ceh = ''' +  FieldByName('CEH_CODE').AsString + ''' ';
      v_Out_Params := Tp_Main_Form.Form_Tech_Proc_Main.F_Gen_Chose_Form( v_In_Params );
      If v_Out_Params <> Nil
      Then
      Begin
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows11UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
begin
  With VGrid_Oper_Params.DataSource.DataSet
  Do
  Begin
    if FieldByName( 'OPER_PPPD' ).AsString = ''
    then
      FieldByName( 'OPER_PPPD' ).AsFloat := TechProcDataFrame.Db_Chem_Cover.FieldByName('Plo').AsFloat;

    If TechProcDataFrame.Db_Doc_Info.FieldByName( 'TP_WORK_TYPE' ).AsInteger = 71
    Then
    Begin
      FieldByName('OPER_OPPP_DET').AsFloat := StrToFloat(Text) * FieldByName('OPER_KDA').AsFloat;
    End
    Else If TechProcDataFrame.Db_Doc_Info.FieldByName( 'TP_WORK_TYPE' ).AsInteger = 55
    Then
    Begin
      if FieldByName('OPER_OPPP_DET').AsString = ''
      then
        FieldByName('OPER_OPPP_DET').AsFloat := 1.66;
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows12UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
begin
  With VGrid_Oper_Params.DataSource.DataSet
  ...
  Begin
    ...
    Begin
      ...
      if FieldByName( 'OPER_KDA' ).AsString = ''
      then
        FieldByName( 'OPER_KDA' ).AsFloat := TechProcDataFrame.Db_Chem_Cover.FieldByName('Plo_P').AsFloat / TechProcDataFrame.Db_Chem_Cover.FieldByName('Plo').AsFloat;
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows13UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
  var
    V_In_Doc_Params,
...
begin
  ...
  Begin
    ...
    Begin
      ...
      V_In_Doc_Params.DynVar[ 'Filter' ].AsString := ' Id = ' + FieldByName( 'MAIN_DOC_ID' ).AsString;
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows14UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
begin
  With VGrid_Oper_Params.DataSource.DataSet
  ...
  Begin
    ...
    then
      FieldByName( 'OPER_PPPD' ).AsFloat := TechProcDataFrame.Db_Chem_Cover.FieldByName('Plo').AsFloat;
    if TechProcDataFrame.Db_Doc_Info.FieldByName( 'TP_WORK_TYPE' ).AsInteger = 55
    Then
    Begin
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows16UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
  var
    V_In_Doc_Params,
...
procedure TFrame_Tp_TechProc_DocDetList.VGrid_Oper_ParamsRows9UpdateData(
  Sender: TObject; var Text: string; var Value: Variant; var UseText,
  Handled: Boolean);
begin
  If TechProcDataFrame.Db_Doc_Info.FieldByName('TP_WORK_TYPE').AsInteger = 71
