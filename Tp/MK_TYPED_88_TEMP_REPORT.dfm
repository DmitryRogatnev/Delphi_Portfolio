object Form_Typed_Tech_Proc_Rep: TForm_Typed_Tech_Proc_Rep
  Left = 0
  Top = 0
  Caption = 'Form_Typed_Tech_Proc_Rep'
  ClientHeight = 397
  ClientWidth = 913
  Color = clBtnFace
  ...
  object frxReport1: TfrxReport
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        '  If <DATA_OPER_PER_TT."TT_PER"> <> '#39#39' Then MasterData12.Visible' +
        ' := True'
      
        '  Else If <DATA_OPER_PER_TT."TT_PER"> = '#39#39' Then MasterData12.Vis' +
        'ible := False;  '
      'end;'
      ''
      ...
      '    Memo256.Visible := True;'
      '    Memo257.Visible := True;'
      '    Memo258.Visible := True;        '
      '  End'
      '  Else'
      '  Begin'
      '    Memo255.Visible := False;      '
      '    Memo256.Visible := False;'
      '    Memo257.Visible := False;'
      '    Memo258.Visible := False;              '
      '  End;'
      '    '
      '  If <Data_5_Normalizer."ELSE_NORM_NAME"> <> '#39#39
      '  Then'
      '  Begin'
      '    Memo259.Visible := True;'
      '    Memo260.Visible := True;'
      '    Memo268.Visible := True;'
      '    Memo269.Visible := True;        '
      '  End'
      '  Else'
      '  Begin'
      '    Memo259.Visible := False;      '
      '    Memo260.Visible := False;'
      '    Memo268.Visible := False;'
      '    Memo269.Visible := False;              '
      '  End;'
      ''
      '  If <Data_6_Normalizer."ELSE_NORM_NAME"> <> '#39#39
      '  Then'
      '  Begin'
      '    Memo270.Visible := True;'
      '    Memo271.Visible := True;'
      '    Memo272.Visible := True;'
      '    Memo273.Visible := True;        '
      '  End'
      '  Else'
      '  Begin'
      '    Memo270.Visible := False;      '
      '    Memo271.Visible := False;'
      '    Memo272.Visible := False;'
      '    Memo273.Visible := False;              '
      '  End;  '
      'end;'
      ''
      ...
      'begin'
        ...
        '  If <Data_Num_Of_Ins."NUM_OF_INS"> <> 0 Then DetailData1.Visibl' +
        'e := True'
      
        '  Else If <Data_Num_Of_Ins."NUM_OF_INS"> = 0 Then DetailData1.Vi' +
        'sible := False;                                     '
      'end;'
      ''
      'begin'
    ...
    object Page5: TfrxReportPage
      ...
      object Overlay2: TfrxOverlay
        ...
        object Memo242: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            #1043#1083#1072#1074#1085#1099#1081' '#1080#1085#1078#1077#1085#1077#1088)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo243: TfrxMemoView
          Left = 642.520100000000000000
          Top = 236.212740000000000000
          Width = 188.976500000000000000
          Height = 26.456710000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo244: TfrxMemoView
          ...
          GapY = 2.000000000000000000
          Memo.UTF8W = (
            #1052#1080#1093#1072#1083#1100#1095#1077#1085#1082#1086' '#1040'. '#1042'.')
          ParentFont = False
          VAlign = vaBottom
        end
        object DATA_SOGL_LISTDOC_UTV_DATE: TfrxMemoView
          Left = 653.858690000000000000
          Top = 275.448789609999900000
        ...
        object Memo168: TfrxMemoView
          ...
          HideZeros = True
          Memo.UTF8W = (
            '[DATA_SOGL_LIST."DOC_UTV_DATE"] '#1075'.')
          ParentFont = False
          VAlign = vaCenter
        end
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object DATA_OPERSDOC_NUM: TfrxMemoView
          Left = 718.110700000000000000
          Width = 120.944960000000000000
          Height = 18.897650000000000000
          StretchMode = smMaxHeight
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo64: TfrxMemoView
          ...
          GapY = 2.000000000000000000
          Memo.UTF8W = (
            #1050#1086#1083'-'#1074#1086' '#1080#1085#1089#1090#1088#1091#1084#1077#1085#1090#1072' '#1085#1072' '#1086#1087#1077#1088#1072#1094#1080#1102': [Data_Num_Of_Ins."NUM_OF_INS"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object DB_EXECUTE_VARIABLES: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      05000000080000001200000056005F0044004F0043005F004E0055004D000100
      ...
      000056005F00540050005F004E0041004D004500010000000000}
