unit Tp_TechProc_DocDetListDataFrame;
...
uses
  ...
  Oracle, MemTableEh, DataDriverEh, OracleData, DynVarsEh, ToolCtrlsEh;

type
  TFrame_Tp_TechProc_DocDetListData = class(TFrame)
    ...
    Db_Doc_DetailsUSER_EDIT: TStringField;
    MemT_Doc_DetailsUSER_EDIT: TStringField;
    ...
    Db_Detail_OperationsI_DATE: TDateTimeField;
    Db_Detail_OperationsI_USER_ID: TStringField;
    Db_Detail_OperationsUSER_ADD_INSERT: TIntegerField;
    Db_Detail_OperationsU_DATE: TDateTimeField;
    Db_Detail_OperationsU_USER_ID: TStringField;
    Db_Detail_OperationsUSER_ADD_CHANGE: TIntegerField;
    Db_Detail_OperationsUSER_EDIT: TStringField;
    MemT_Detail_OperationsI_DATE: TDateTimeField;
    MemT_Detail_OperationsI_USER_ID: TStringField;
    MemT_Detail_OperationsUSER_ADD_INSERT: TIntegerField;
    MemT_Detail_OperationsU_DATE: TDateTimeField;
    MemT_Detail_OperationsU_USER_ID: TStringField;
    MemT_Detail_OperationsUSER_ADD_CHANGE: TIntegerField;
    MemT_Detail_OperationsUSER_EDIT: TStringField;
    MemT_Oper_TimeUSER_EDIT: TStringField;
    Db_Oper_TimeCALC_FROM: TStringField;
    MemT_Oper_TimeCALC_FROM: TStringField;
    Db_Chem_Cover: TOracleDataSet;
    Db_Chem_CoverID_DET: TFloatField;
    Db_Chem_CoverPLO: TFloatField;
    Db_Chem_CoverPLO_P: TFloatField;
    Db_Chem_CoverKOLSL: TFloatField;
    Db_Chem_CoverTOLPOKR: TFloatField;
    Db_Chem_CoverTOL_POKR: TStringField;
    Db_Chem_CoverGRSL: TFloatField;
    Db_Chem_CoverCOLOR_ID: TFloatField;
    Db_Doc_DetailsUSER_NAME: TStringField;
    MemT_Doc_DetailsUSER_NAME: TStringField;
    Db_Detail_OperationsUSER_NAME: TStringField;
    MemT_Detail_OperationsUSER_NAME: TStringField;
    ...
    procedure MemT_Doc_DetailsAfterScroll(DataSet: TDataSet);
  private
...
constructor TFrame_Tp_TechProc_DocDetListData.Create(AOwner: TComponent; InDocHeaderId: Integer);
begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Detail_OperationsNewRecord(DataSet: TDataSet);
  var
  v_User_In_Params,
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Doc_DetailsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Doc_DetailsAfterScroll(
  DataSet: TDataSet);
begin
  Db_Chem_Cover.SetVariable('Det_Id', DataSet.FieldByName('Det_Id').AsString);
  Db_Chem_Cover.Refresh;
end;

procedure TFrame_Tp_TechProc_DocDetListData.MemT_Doc_DetailsBeforeDelete(DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Doc_DetailsBeforeEdit(DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Doc_DetailsNewRecord(DataSet: TDataSet);
  var
  v_User_In_Params,
  v_User_Out_Params: TDynVarsEh;
begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_TimeBeforeDelete(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_TimeBeforeEdit(
  DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_TimeNewRecord(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_Time_WorksBeforeDelete(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_Time_WorksBeforeEdit(
  DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
...
procedure TFrame_Tp_TechProc_DocDetListData.MemT_Oper_Time_WorksNewRecord(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrame_Tp_TechProc_DocDetListData.P_Delete_ChildDataSet(ParentMemTable: TMemTableEh;
...
procedure TFrame_Tp_TechProc_DocDetListData.P_FlagDelete_ChildDataSet(
