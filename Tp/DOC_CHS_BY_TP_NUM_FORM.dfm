object Form54: TForm54
  ...
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1058#1055
  ClientHeight = 309
  ClientWidth = 645
  Color = clBtnFace
  ...
  object DB_TP_DOCS: TOracleDataSet
    SQL.Strings = (
      ...
      'Where upper(t.Tp_Num) Like '#39'%'#39'||upper(:v_KeyWord)||'#39'%'#39
      '      And t.Main_Doc_Id Is Null'
      '      And t.Tp_Num Is Not Null'
      '      And t.Doc_Type <> 5')
    Optimize = False
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      050000000D00000004000000490044000100000000000C000000440045005400
