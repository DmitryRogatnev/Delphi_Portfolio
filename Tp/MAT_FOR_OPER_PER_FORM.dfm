object Form_Per_Mat: TForm_Per_Mat
  ...
  object Grid_Per_Mat: TDBGridEh
    ...
    DataSource = Form_Tech_Proc_Info.DATA_PER_MATERIALS
    DynProps = <>
    Flat = True
    OddRowColor = clMenu
  ...
  object Main_M_Per_Mat: TMainMenu
    ...
    object Main_M_Per_Mat_Btn_Copy_Mat_From_Rcd: TMenuItem
      ...
      OnClick = Main_M_Per_Mat_Btn_Copy_Mat_From_RcdClick
    end
  ...
  object Db_Norm_Mat_Det: TOracleDataSet
    SQL.Strings = (
      'Select ( Select b.Id'
      '         From   Ogt.Spr_Matx_Txt b'
      '         Where   b.Mat = a.Mat_Txt ) Mat_Id,'
      '       Mat_Txt Mat_Name,'
      '       Norma Norma_Min,'
      '       Ed_Txt Ed_Name,'
      '       ( Select b.Id'
      '         From   Ogt.Spr_Ed b'
      '         Where  Ed = a.Ed_Txt ) Ed_Id'
      'From   Ogt.Norm_Mat_All_Txt a'
      'Where  a.Det_Txt = ( Select b.Det'
      '                     From   Ogt.Spr_Det_Txt b'
      '                     Where  b.Id = :v_Det_Id )'
      '       And a.Ceh_Txt = :v_Ceh_Code')
    Optimize = False
    Variables.Data = {
      ...
      44004500050000000000000000000000}
