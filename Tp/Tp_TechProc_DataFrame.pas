...
uses
  ...
  IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, IdHTTP, Oracle,
  MemTableEh, DataDriverEh, OracleData, ToolCtrlsEh, DynVarsEh;

type
  TFrameData_TechProc = class(TFrame)
    ...
    Seq_Db_Oper_Files: TOracleQuery;
    Db_Doc_PartsUSER_EDIT: TStringField;
    MemT_Doc_PartsUSER_EDIT: TStringField;
    MemT_Oper_ParamsUSER_EDIT: TStringField;
    Db_Oper_TimeUSER_EDIT: TStringField;
    MemT_Oper_TimeUSER_EDIT: TStringField;
    Db_Oper_Time_WorksUSER_EDIT: TStringField;
    MemT_Oper_Time_WorksUSER_EDIT: TStringField;
    Db_Instr_CardUSER_EDIT: TStringField;
    MemT_Instr_CardUSER_EDIT: TStringField;
    Db_Instr_Crd_PrmsUSER_EDIT: TStringField;
    MemT_Instr_Crd_PrmsUSER_EDIT: TStringField;
    Db_Oper_FilesUSER_ID_INSRT: TStringField;
    Db_Oper_FilesUSER_ADD_INSERT: TIntegerField;
    Db_Oper_FilesDATE_INSRT: TDateTimeField;
    Db_Oper_FilesUSER_ID_CORR: TStringField;
    Db_Oper_FilesUSER_ADD_CHANGE: TIntegerField;
    Db_Oper_FilesUSER_EDIT: TStringField;
    MemT_Oper_FilesUSER_ID_INSRT: TStringField;
    MemT_Oper_FilesUSER_ADD_INSERT: TIntegerField;
    MemT_Oper_FilesDATE_INSRT: TDateTimeField;
    MemT_Oper_FilesUSER_ID_CORR: TStringField;
    MemT_Oper_FilesUSER_ADD_CHANGE: TIntegerField;
    MemT_Oper_FilesUSER_EDIT: TStringField;
    Db_Per_DetailsUSER_EDIT: TStringField;
    MemT_Per_DetailsUSER_EDIT: TStringField;
    Db_Per_MaterialsUSER_EDIT: TStringField;
    MemT_Per_MaterialsUSER_EDIT: TStringField;
    Db_Per_InstrumentsUSER_EDIT: TStringField;
    MemT_Per_InstrumentsUSER_EDIT: TStringField;
    Db_Per_OsnastUSER_EDIT: TStringField;
    MemT_Per_OsnastUSER_EDIT: TStringField;
    Db_Oper_PerUSER_EDIT: TStringField;
    MemT_Oper_PerUSER_EDIT: TStringField;
    Db_Per_ParamsUSER_EDIT: TStringField;
    MemT_Per_ParamsUSER_EDIT: TStringField;
    Db_Ins_Crd_Per_InstrsUSER_EDIT: TStringField;
    MemT_Ins_Crd_Per_InstrsUSER_EDIT: TStringField;
    Db_Ins_Crd_Per_Link_InstrsUSER_EDIT: TStringField;
    Db_Ins_Crd_Ins_TmpltsUSER_EDIT: TStringField;
    MemT_Ins_Crd_Ins_TmpltsUSER_EDIT: TStringField;
    Db_Ins_Crd_Ins_Tmp_PrmsUSER_EDIT: TStringField;
    MemT_Ins_Crd_Ins_Tmp_PrmsUSER_EDIT: TStringField;
    ...
    Db_Oper_ParamsUSER_EDIT: TStringField;
    ...
    Db_Oper_PerUSER_ADD_INSERT: TIntegerField;
    Db_Oper_PerUSER_ADD_CHANGE: TIntegerField;
    Db_Oper_PerUSER_NAME: TStringField;
    MemT_Oper_PerUSER_ADD_INSERT: TIntegerField;
    MemT_Oper_PerUSER_ADD_CHANGE: TIntegerField;
    MemT_Oper_PerUSER_NAME: TStringField;
    Db_Oper_TimeCALC_FROM: TStringField;
    MemT_Oper_TimeCALC_FROM: TStringField;
    Db_OpersPARAM_OTK: TStringField;
    Db_OpersMEANS_OTK: TStringField;
    Db_OpersVOLUME_OTK: TStringField;
    MemT_OpersPARAM_OTK: TStringField;
    MemT_OpersMEANS_OTK: TStringField;
    MemT_OpersVOLUME_OTK: TStringField;
    Db_Oper_TimeOTHER_TIME: TFloatField;
    MemT_Oper_TimeOTHER_TIME: TFloatField;
    Db_TechProcSomeInformation: TOracleDataSet;
    Data_TechProcSomeInformation: TDataSource;
    Db_TechProcSomeInformationSOME_INFORMATION: TStringField;
    Db_TechProcSomeInformationDOC_HEADER_ID: TFloatField;
    ...
    procedure MemT_Per_ItemsNewRecord(DataSet: TDataSet);
    ...
    procedure MemT_Oper_FilesNewRecord(DataSet: TDataSet);
    procedure MemT_Oper_FilesAfterEdit(DataSet: TDataSet);
    procedure MemT_Oper_TimeBeforeEdit(DataSet: TDataSet);
    procedure MemT_Oper_Time_WorksBeforeEdit(DataSet: TDataSet);
    procedure MemT_Oper_PerAfterDelete(DataSet: TDataSet);
    procedure MemT_Doc_PartsAfterPost(DataSet: TDataSet);
  private
  ...
  public
    ...
    Arr_DataSetsOpenLine: Array Of TDataSet;
    Arr_DataSetsSaveLine: Array Of TDataSet;
...
uses
  Udm_Main, Tp_Main_Form, Tp_Per_Instr_Card;

constructor TFrameData_TechProc.Create(AOwner: TComponent; InDocHeaderId: Integer);
begin
  ...
  Arr_DataSetsOpenLine := [ Db_Doc_Info,
                            Db_Frame_Params,
                            MemT_Doc_Parts,
                            Db_Oper_Params_List,
                            Db_Per_Params_List,
...
procedure TFrameData_TechProc.Data_Instr_CardDataChange(Sender: TObject;
  Field: TField);
Var
...
procedure TFrameData_TechProc.Data_Ins_Crd_Ins_TmpltsDataChange(Sender: TObject;
  Field: TField);
Var
  I: Integer;
begin
...
procedure TFrameData_TechProc.Data_Ins_Crd_Per_InstrsDataChange(Sender: TObject;
  Field: TField);
 var
  Mem_Strm: TMemoryStream;
  Img_Temp_File_Path: String;
...
procedure TFrameData_TechProc.Db_Instr_CardApplyRecord(Sender: TOracleDataSet;
...
procedure TFrameData_TechProc.MemT_Doc_PartsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
    if (Db_Doc_Info.FieldByName('Id_Vers').AsInteger <> FieldByName('DOC_TP_VERS_ID').AsInteger)
    then
    begin
...
procedure TFrameData_TechProc.MemT_Doc_PartsAfterPost(DataSet: TDataSet);
  var
    i: Integer;
...
begin
  ...
  begin
    ...
    then
      NumPosField := 'Row_Num'
    else if DataSet=MemT_Opers
    then
      NumPosField := 'Nomoper'
    else if DataSet=MemT_Oper_Per
    then
      NumPosField := 'Nom_Per';
...
procedure TFrameData_TechProc.MemT_Doc_PartsNewRecord(DataSet: TDataSet);
Var
  Doc_Id: Integer;
begin
  With DataSet
  Do
  Begin
    Seq_Db_Doc_Parts.Execute;
    FieldByName('ID').AsInteger := Seq_Db_Doc_Parts.FieldAsInteger(0);
    ...
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
...
procedure TFrameData_TechProc.MemT_Instr_CardAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Instr_CardAfterPost(DataSet: TDataSet);
Var
  I: Integer;
begin
  With Db_Instr_Crd_Tmp_Prms_List
...
procedure TFrameData_TechProc.MemT_Instr_CardAfterScroll(DataSet: TDataSet);
Var
  I: Integer;
begin
  With Db_Instr_Crd_Tmp_Prms_List
...
procedure TFrameData_TechProc.MemT_Instr_CardNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Instr_Crd_PrmsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Instr_Crd_PrmsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_TmpltsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_TmpltsAfterPost(DataSet: TDataSet);
Var
  I: Integer;
begin
  With Db_Instr_Tmplt_Prms_List
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_TmpltsAfterScroll(DataSet: TDataSet);
Var
  I: Integer;
begin
  With Db_Instr_Tmplt_Prms_List
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_TmpltsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_Tmp_PrmsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Ins_Tmp_PrmsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Per_InstrsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Per_InstrsAfterScroll(DataSet: TDataSet);
 var
  Mem_Strm: TMemoryStream;
  Img_Temp_File_Path: String;
begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Per_InstrsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Ins_Crd_Per_Link_InstrsAfterEdit(
  DataSet: TDataSet);
begin
  with DataSet
  do
...
procedure TFrameData_TechProc.MemT_OpersAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
    ...
    FieldByName('User_Name').AsString := Udm_Main.DM_Main.F_Oracle('stp.pkg_user.F_Get_User_fio()',[]);
  end;
end;

procedure TFrameData_TechProc.MemT_OpersAfterPost(DataSet: TDataSet);
var
  I: Integer;
  UserInsertField, NumPosField: String;
begin
...
procedure TFrameData_TechProc.MemT_OpersAfterScroll(DataSet: TDataSet);
var
  I: Integer;
begin
  Db_Oper_Params_List.SetVariable('v_Oper_Id', DataSet.FieldByName('OPER_ID').AsString);
...
procedure TFrameData_TechProc.MemTableEhBeforeDelete(DataSet: TDataSet);
var
  i: Integer;
begin
  ...
  Begin
    ...
    if (DataSet.FieldByName('User_Edit').AsString <> Dm_Main.Session.LogonUsername )
        and (Db_Doc_Info.FieldByName('DOC_EDIT_STAT').AsString <> 'UNLOCK_FOR_NORM')
        and (StrList_DataSetsForNorms.IndexOf(DataSet.Name) = -1)
    then
      Abort;
  ...
  if DataSet.FindField('Id_Doc_Tp') <> Nil
  then
  begin
    if DataSet.FieldByName('Id_Doc_Tp').AsInteger <> Db_Doc_Info.FieldByName('Id').AsInteger
    then
      Abort;
  end
  else if DataSet.FindField('Doc_Tp_Id') <> Nil
  then
  begin
    if DataSet.FieldByName('Doc_Tp_Id').AsInteger <> Db_Doc_Info.FieldByName('Id').AsInteger
    then
      Abort;
  end
  else if DataSet.FindField('Doc_In') <> Nil
  then
  begin
    if DataSet.FieldByName('Doc_In').AsInteger <> Db_Doc_Info.FieldByName('Id').AsInteger
    then
      Abort;
  end;
...
procedure TFrameData_TechProc.P_Delete_ChildDataSet(ParentMemTable: TMemTableEh; ParentRec: TMemoryRecordEh);
Var
  I: Integer;
  procedure P_DeleteChild (ChildMemTable: TMemTableEh);
  var
    I, j: Integer;
    StrDetailListKeyFields, StrMasterListKeyFields: TStringList;
    DetailKeyFieldValue, MasterKeyFieldValue: String;
    ...
    Begin
      ...
      Try
        ...
        Begin
          ...
          do
          Begin
            if Pos(';', DetailFields)<>0
            then
            begin
              StrDetailListKeyFields := TStringList.Create;
              StrDetailListKeyFields.Delimiter := ';';
              StrDetailListKeyFields.DelimitedText := DetailFields;
              for j := 0 to StrDetailListKeyFields.Count-1
              do
              begin
                if j = 0
                then
                  DetailKeyFieldValue := VarToStr(Rec[i].DataValues[StrDetailListKeyFields[j], dvvValueEh])
                else
                  DetailKeyFieldValue := DetailKeyFieldValue + ';' + VarToStr(Rec[i].DataValues[StrDetailListKeyFields[j], dvvValueEh]);
              end;

              StrMasterListKeyFields := TStringList.Create;
              StrMasterListKeyFields.Delimiter := ';';
              StrMasterListKeyFields.DelimitedText := MasterFields;
              for j := 0 to StrMasterListKeyFields.Count-1
              do
              begin
                if j = 0
                then
                  MasterKeyFieldValue := VarToStr(ParentRec.DataValues[StrMasterListKeyFields[j], dvvValueEh])
                else
                  MasterKeyFieldValue := MasterKeyFieldValue + ';' + VarToStr(ParentRec.DataValues[StrMasterListKeyFields[j], dvvValueEh]);
              end;
            end
            else
            begin
              DetailKeyFieldValue := VarToStr(Rec[i].DataValues[DetailFields, dvvValueEh]);
              MasterKeyFieldValue := VarToStr(ParentRec.DataValues[MasterFields, dvvValueEh])
            end;

            if DetailKeyFieldValue=MasterKeyFieldValue
            then
              AccessToDelete :=True
            else
...
procedure TFrameData_TechProc.P_Delete_Child_Rec(Vl_MemRec: TMemoryRecordEh;
...
procedure TFrameData_TechProc.P_FlagDelete_ChildDataSet(ParentMemTable: TMemTableEh; ParentRec: TMemoryRecordEh);
Var
  I: Integer;
...
procedure TFrameData_TechProc.P_FlagDelete_Child_Rec(Vl_MemRec: TMemoryRecordEh;
  Vl_Start_Pos: String; Vl_UpdateStatus: TUpdateStatus);
...
procedure TFrameData_TechProc.MemTableEhBeforeEdit(DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
    ...
    Then
    Begin
      If ( Pkg_Tp_Doc.CallIntegerFunction( 'F_Access_To_Edit_Dep', [ DM_Main.Session.LogonUsername, MemT_Doc_Parts.FieldByName('Dep_Id').AsInteger ] ) = 0 )
      Then
      Begin
        Abort;
      End;
...
procedure TFrameData_TechProc.MemTableEhBeforeInsert(DataSet: TDataSet);
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        FieldsList.Delimiter := ';';
        FieldsList.DelimitedText := MasterFields;

        for i :=0 to FieldsList.Count-1
        do
        begin
          if MasterSource.DataSet.FieldByName(FieldsList[i]).IsNull
          then
            Abort;
        end;
      end;
...
procedure TFrameData_TechProc.MemT_OpersGetFieldValue(MemTable: TCustomMemTableEh;
  Field: TField; var Value: Variant);
begin
...
procedure TFrameData_TechProc.MemT_OpersNewRecord(DataSet: TDataSet);
  var
  v_In_User_Params,
...
begin
  ...
  Begin
    ...
    FieldByName('CEH_CODE').AsString := MemT_Doc_Parts.FieldByName('CEH_CODE').AsString;
    ...
    Then
    Begin
      FieldByName('USER_NAME').AsString := v_Out_User_Params.DynVar[ 'EMP_FIO' ].AsString;
    End;
  End;
end;

procedure TFrameData_TechProc.MemT_Oper_FilesAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Oper_FilesNewRecord(DataSet: TDataSet);
...
begin
  ...
  do
  begin
    FieldByName( 'DATAIZM' ).AsString := DateTimeToStr(Now());
    FieldByName( 'ID_ROW_OPER' ).AsInteger :=  MemT_OpersID_ROW_OPER.AsInteger;
    Seq_Db_Oper_Files.Execute;
    FieldByName( 'ID' ).AsInteger := Seq_Db_Oper_Files.FieldAsInteger(0);
    FieldByName( 'ID_DOC_TP' ).AsInteger := Db_Doc_Info.FieldByName('ID').AsInteger;
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
    if Db_Doc_Info.FieldByName('Id_Vers').AsInteger <> 1
    then
...
procedure TFrameData_TechProc.MemT_Oper_ParamsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Oper_ParamsBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFrameData_TechProc.MemT_Oper_ParamsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
...
procedure TFrameData_TechProc.MemT_Oper_PerAfterDelete(DataSet: TDataSet);
  var
    i: Integer;
    UserInsertField, NumPosField: String;
begin
...
procedure TFrameData_TechProc.MemT_Oper_PerAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Oper_PerAfterPost(DataSet: TDataSet);
Var
  I: Integer;
  UserInsertField, NumPosField: String;
begin
...
procedure TFrameData_TechProc.MemT_Oper_PerAfterScroll(DataSet: TDataSet);
Var
  I: Integer;
begin
  With Db_Per_Params_List
...
procedure TFrameData_TechProc.MemT_Oper_PerGetFieldValue(MemTable: TCustomMemTableEh;
  Field: TField; var Value: Variant);
begin
  If Not MemTable.IsEmpty
  Then
...
procedure TFrameData_TechProc.MemT_Oper_PerNewRecord(DataSet: TDataSet);
  var
  v_In_User_Params,
  v_Out_User_Params: TDynVarsEh;
begin
  ...
  Do
  Begin
    FieldByName('ID_ROW_OPER').AsInteger := MemT_Opers.FieldByName('ID_ROW_OPER').AsInteger;
    FieldByName('NOM_PER').AsInteger := MemT_Oper_Per.RecordsView.Count + 1;
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
    if Db_Doc_Info.FieldByName('Id_Vers').AsInteger <> 1
    then
      FieldByName('Rw_status').AsString := 'inserted'
    ...
    FieldByName('ID').AsInteger := Seq_Db_Oper_Per.FieldAsInteger(0);
    FieldByName('ID_RW_VERS').AsInteger := 1;
    FieldByName('DATAIZM').AsString := DateTimeToStr(Now());
    ...
    Begin
      FieldByName('RAZRAB').AsInteger := MemT_Opers.FieldByName('RAZRAB').AsInteger;
      v_In_User_Params.DynVar[ 'Filter' ].AsString := ' Emp_Id = ' + MemT_Opers.FieldByName('RAZRAB').AsString;
    End
    Else if not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin then
    Begin
      FieldByName('USER_ID_INSRT').AsString := DM_Main.Session.LogonUsername;
      FieldByName('USER_ID_CORR').AsString := DM_Main.Session.LogonUsername;
      MemT_Oper_Per.FieldByName('RAZRAB').AsInteger := Tp_Main_Form.Form_Tech_Proc_Main.User_lnum;
      v_In_User_Params.DynVar[ 'Filter' ].AsString := ' Emp_Id = ' + IntToStr( Tp_Main_Form.Form_Tech_Proc_Main.User_lnum )
                                                      + ' And Id_User = ''' + Udm_Main.DM_Main.Session.LogonUsername + ''' ';
    End;
    v_Out_User_Params := Tp_Main_Form.Form_Tech_Proc_Main.F_Gen_Chose_Form( v_In_User_Params );
...
procedure TFrameData_TechProc.MemT_Oper_TimeAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Oper_TimeBeforeEdit(DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
...
procedure TFrameData_TechProc.MemT_Oper_TimeNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
    ...
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
    FieldByName('DOC_TP_VERS_ID').AsInteger := Db_Doc_Info.FieldByName('ID_VERS').AsInteger;
    FieldByName('Calc_From').AsString := 'norm';
...
procedure TFrameData_TechProc.MemT_Oper_Time_WorksAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Oper_Time_WorksBeforeEdit(DataSet: TDataSet);
begin
  If Not Tp_Main_Form.Form_Tech_Proc_Main.User_Admin
  Then
  Begin
...
procedure TFrameData_TechProc.MemT_Oper_Time_WorksNewRecord(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
    FieldByName('OPER_RW_ID').AsInteger := MemT_OpersID_ROW_OPER.AsInteger;
    FieldByName('DOC_TP_ID').AsInteger := Db_Doc_Info.FieldByName('ID').AsInteger;
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
...
procedure TFrameData_TechProc.MemT_Per_DetailsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Per_ItemsNewRecord(DataSet: TDataSet);
  var
  v_In_User_Params,
  v_Out_User_Params: TDynVarsEh;
begin
  ...
  do
  begin
    FieldByName('ID_ROW_PER').AsInteger := MemT_Oper_PerId.AsInteger;
    FieldByName('DOK_IN').AsInteger := Db_Doc_Info.FieldByName('ID').AsInteger;
    FieldByName('DOC_TP_VERS_ID').AsInteger := Db_Doc_Info.FieldByName('ID_VERS').AsInteger;
    FieldByName('USER_EDIT').AsString := DM_Main.Session.LogonUsername;
    if Db_Doc_Info.FieldByName('Id_Vers').AsInteger <> 1
    ...
    if DataSet = MemT_Per_Details
    then
    begin
      Seq_Db_Per_Details.Execute;
      FieldByName('ID').AsInteger := Seq_Db_Per_Details.FieldAsInteger(0);
    end
    else if DataSet = MemT_Per_Materials
    then
    begin
      Seq_Db_Per_Materials.Execute;
      FieldByName('ID').AsInteger := Seq_Db_Per_Materials.FieldAsInteger(0);
    end
    else if DataSet = MemT_Per_Instruments
    then
    begin
      Seq_Db_Per_Instruments.Execute;
      FieldByName('ID').AsInteger := Seq_Db_Per_Instruments.FieldAsInteger(0);
      FieldByName('NOM_INSTR').AsInteger := MemT_Per_Instruments.RecordCount + 1;
    end
    else if DataSet = MemT_Per_Osnast
    then
    begin
      Seq_Db_Per_Osnast.Execute;
      FieldByName('ID').AsInteger := Seq_Db_Per_Osnast.FieldAsInteger(0);
      FieldByName('SHOSN_NOM').AsInteger := MemT_Per_Osnast.RecordCount + 1;
    end;
    ...
    if Tp_Main_Form.Form_Tech_Proc_Main.User_Admin then
    Begin
      FieldByName('RAZRAB').AsInteger := MemT_Oper_PerRAZRAB.AsInteger;
...
procedure TFrameData_TechProc.MemT_Per_InstrumentsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Per_MaterialsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Per_OsnastAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Per_ParamsAfterEdit(DataSet: TDataSet);
begin
  with DataSet
  do
  begin
...
procedure TFrameData_TechProc.MemT_Per_ParamsNewRecord(DataSet: TDataSet);
begin
  With DataSet
  Do
  Begin
