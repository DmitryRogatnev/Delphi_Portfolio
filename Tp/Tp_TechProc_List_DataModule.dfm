object Dm_TechProc_List: TDm_TechProc_List
  ...
  object Db_Doc_Details: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      #9#9#9#9#9#9'when t.Id_Doc_Tp = :Id'
    ...
    Optimize = False
    Variables.Data = {
      
      490044005F0044004F004300050000000000000000000000}
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      050000001A000000040000004900440001000000000012000000490044005F00
    ...
    Master = Db_Doc_Info
    MasterFields = 'Id; Id_Vers;Parent_Id_Doc;Parent_Id_Vers'
  ...
  object Db_Oper_Time_Works: TOracleDataSet
    ...
    Variables.Data = {
      ...
      490044005F0044004F004300050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000000E0000001C000000490044005F00520057005F004F0050005F005700
  ...
  object Db_Detail_Operations: TOracleDataSet
    SQL.Strings = (
      ...
      'Left   Join Ogt.V_Tp_Ok_Dlp O'
      'On     O.Id_Row_Oper = t.Id_Row_Oper'
      
        '       And O.Id_Rw_Vers = Ogt.pkg_tp_doc.f_get_oper_lastidvers(i' +
        'n_id_row_oper => t.Id_Row_Oper)'
      'Left   Join Ogt.V_Spr_Tp_Doc_Actual Info'
      'On     t.Id_Doc_Tp = Info.Id'
      'Where ((Case'
      '             when t.Id_Doc_Tp  = :Id'
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0500000035000000040000004900440001000000000012000000490044005F00
      44004F0043005F00540050000100000000000C0000004400450054005F004900
