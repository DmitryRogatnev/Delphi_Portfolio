object Dm_Tech_Proc: TDm_Tech_Proc
  ...
  object Db_Doc_Parts: TOracleDataSet
    SQL.Strings = (
      ...
      '                     Or t.Doc_Tp_Vers_Id <= :Parent_Id_Vers) '
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select a.Id_Rw_Vers '
      #9#9#9#9' From   Ogt.V_Tp_Ok_Mar_Parts_Vers a'
      #9#9#9#9' Where  a.Id = t.Id'
      
        '                                        And a.Rw_Status In ('#39'upd' +
        'ated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Id_Doc_Tp  In (:Id, :Parent_Id_Doc)'
      
        '                                        And a.Doc_Tp_Vers_Id In ' +
        '(:Parent_Id_Vers, :Id_Vers))'
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      '           when t.Id_Doc_Tp  = :Parent_Id_Doc'
      
        '                And t.Doc_Tp_Vers_Id In (:Parent_Id_Vers, :Id_Ve' +
        'rs)'
      '                And t.Rw_Status In ('#39'inserted'#39', '#39'updated'#39')'
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      '            when t.Id_Doc_Tp  = :Id'
      '                And t.Doc_Tp_Vers_Id = :Id_Vers'
      ...
      #9#9#9#9' From   Ogt.V_Tp_Ok_Mar_Parts_Vers a'
      #9#9#9#9' Where  a.Id = t.Id'
      #9#9#9#9'        And a.Id_Doc_Tp  = :Id'
      
        '                                        And a.Doc_Tp_Vers_Id = :' +
        'Id_Vers)'
      #9#9'And Not Exists ( Select a.Id_Rw_Vers '
      #9#9#9#9' From   Ogt.V_Tp_Ok_Mar_Parts_Vers a'
      #9#9#9#9' Where  a.Id = t.Id'
      #9#9#9#9'        And a.Rw_Vers = '#39'current_version'#39
      #9#9#9#9#9'And a.Rw_Status = '#39'deleted'#39
      #9#9#9#9'        And a.Id_Doc_Tp  = :Id'
      
        '                                        And a.Doc_Tp_Vers_Id < :' +
        'Id_Vers )'
      '                And t.Rw_Vers = '#39'old_version'#39
      '            then 1 '
      '       end) = 1)'
      '       Or( t.Id_Doc_Tp  = :Linked_Doc_Id '
      '           And t.Id_Doc_Tp <> :Id )'
      'Order by t.Row_Num')
    Optimize = False
    Variables.Data = {
      04000000050000001C0000003A004C0049004E004B00450044005F0044004F00
      ...
      0053000500000000000000000000001E0000003A0050004100520045004E0054
      005F00490044005F0056004500520053000500000000000000000000001C0000
      003A0050004100520045004E0054005F00490044005F0044004F004300050000
      000000000000000000}
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0500000012000000040000004900440001000000000012000000490044005F00
      ...
      5F0055005300450052005F00490044005F00410044004400010000000000}
    UniqueFields = 'ID; ID_RW_VERS'
    Master = Db_Doc_Info
    MasterFields = 'Id; Id_Vers; Linked_Doc_Id;Parent_Id_Doc;Parent_Id_Vers'
  ...
  object Db_Opers: TOracleDataSet
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      05000000210000000E0000004E004F004D004F00500045005200010000000000
      ...
      
      4D004500010000000000}
    UniqueFields = 'ID_ROW_OPER; ID_RW_VERS'
    Master = Db_Doc_Info
    MasterFields = 
      'Id; Id_Vers; Linked_Doc_Id;Parent_Id_Doc;Parent_Id_Vers; Doc_Hea' +
      'der_Id'
  ...
  object Db_Per_Details: TOracleDataSet
    SQL.Strings = (
      ...
      '                     Or t.Doc_Tp_Vers_Id <= :Parent_Id_Vers) '
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_DET_DLP_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Dok_In  In (:Id, :Parent_Id_Doc)'
      
        '                                        And a.Doc_Tp_Vers_Id In ' +
        '(:Parent_Id_Vers, :Id_Vers))'
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      '           when t.Dok_In = :Parent_Id_Doc'
      ...
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      #9#9#9#9#9#9'when t.Dok_In = :Id'
      #9#9#9#9#9#9'    And t.Doc_Tp_Vers_Id = :Id_Vers'
      #9#9#9#9#9#9'    And ( t.Rw_Status = '#39'deleted'#39
      
        '                                                          Or t.R' +
        'w_Vers = '#39'old_version'#39' )'
      #9#9#9#9#9#9'then 1'
      '            when t.Dok_In = :Id'
      '                And t.Doc_Tp_Vers_Id < :Id_Vers'
      #9#9'And Not Exists ( Select 1'
      ...
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_DET_DLP_Vers a'
      #9#9#9#9' Where   a.Rw_Vers = '#39'current_version'#39
      #9#9#9#9#9'And a.Rw_Status = '#39'deleted'#39
      #9#9#9#9'        And a.Dok_In = :Id'
      
        '                                        And a.Doc_Tp_Vers_Id < :' +
        'Id_Vers )'
      '                And t.Rw_Vers = '#39'old_version'#39
      '            then 1 '#9#9#9#9#9#9#9
      '       end) = 1)'
      '       Or( Info.Main_Doc_Id = :Linked_Doc_Id '
      '           And t.Dok_In <> :Id )'
      '')
    Optimize = False
    Variables.Data = {
      
      00000000}
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
  ...
  object MemT_Per_Details: TMemTableEh
    ...
    BeforeDelete = MemTableEhBeforeDelete
    OnNewRecord = MemT_Per_DetailsNewRecord
    Left = 32
    Top = 400
  ...
  object Db_Oper_Per: TOracleDataSet
    ...
    Variables.Data = {
      
      00000000}
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      050000001800000004000000490044000100000000000E0000004E004F004D00
      ...
      54004100540055005300010000000000}
    UniqueFields = 'ID; ID_RW_VERS'
    Master = Db_Doc_Info
    MasterFields = 'Id; Id_Vers; Linked_Doc_Id;Parent_Id_Doc;Parent_Id_Vers'
  ...
  object MemT_Per_Materials: TMemTableEh
    ...
    BeforeDelete = MemTableEhBeforeDelete
    OnNewRecord = MemT_Per_MaterialsNewRecord
    Left = 128
    Top = 400
  ...
  object Db_Per_Materials: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_MAT_DLP_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Dok_In  In (:Id, :Parent_Id_Doc)'
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0500000017000000040000004900440001000000000014000000490044005F00
      ...
      0000520057005F00530054004100540055005300010000000000}
    UniqueFields = 'ID'
    Master = Db_Doc_Info
    MasterFields = 'Id; Id_Vers; Linked_Doc_Id;Parent_Id_Doc;Parent_Id_Vers'
  ...
  object MemT_Per_Instruments: TMemTableEh
    ...
    BeforeDelete = MemTableEhBeforeDelete
    OnNewRecord = MemT_Per_InstrumentsNewRecord
    Left = 240
    Top = 400
  ...
  object Db_Per_Instruments: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_INS_DLP_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Dok_In  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      
      000000000000000000}
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
  ...
  object MemT_Per_Osnast: TMemTableEh
    ...
    BeforeDelete = MemTableEhBeforeDelete
    OnNewRecord = MemT_Per_OsnastNewRecord
    Left = 360
    Top = 400
  ...
  object Db_Per_Osnast: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_OSN_DLP_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Dok_In  In (:Id, :Parent_Id_Doc)'
  ...
  object Db_Oper_Params: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_OPER_PARAMS_VERS a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
      
        '                                        And a.Doc_Tp_Vers_Id In ' +
        '(:Parent_Id_Vers, :Id_Vers))'
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      '           when t.Doc_Tp_Id = :Parent_Id_Doc'
      ...
      '                And t.Rw_Vers = '#39'current_version'#39
      #9'    then 1'
      #9#9#9#9#9#9'when t.Doc_Tp_Id = :Id'
      #9#9#9#9#9#9'    And t.Doc_Tp_Vers_Id = :Id_Vers'
      #9#9#9#9#9#9'    And ( t.Rw_Status = '#39'deleted'#39
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000001300000020000000490044005F0052004F0057005F00540050005F00
  ...
  object Db_Per_Params: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_TP_OK_PER_PARAMS_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      05000000120000001200000044004F0043005F00540050005F00490044000100
  ...
  object Db_Oper_Time: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_Oper_Time_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000001A0000001200000044004F0043005F00540050005F00490044000100
  ...
  object Db_Oper_Time_Works: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_Oper_T_Wrk_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000000F0000001C000000490044005F00520057005F004F0050005F005700
  ...
  object Db_Doc_Info: TOracleDataSet
    SQL.Strings = (
      ...
      'On     Det.Id = t.Det_Id  '
      'Where  t.Id_Doc_Full = :In_Doc_Id')
    Optimize = False
    Variables.Data = {
      0400000001000000140000003A0049004E005F0044004F0043005F0049004400
      050000000D0000003030303030333031303030310000000000}
    QBEDefinition.QBEFieldDefs = {
      050000003100000004000000490044000100000000000E00000044004F004300
      ...
      
      ...
      5300010000000000280000004C0049004E004B00450044005F0044004F004300
      5F004800450041004400450052005F0049004400010000000000}
    Session = DM_Main.Session
    Left = 1064
    Top = 64
  ...
  object Db_Instr_Card: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_Oper_Ins_Crds_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      05000000140000001A000000490044005F00520057005F0049004E0053005F00
    ...
    Master = Db_Doc_Info
    MasterFields = 'Id; Id_Vers; Linked_Doc_Id;Parent_Id_Doc;Parent_Id_Vers'
    OnApplyRecord = Db_Instr_CardApplyRecord
  ...
  object Db_Instr_Crd_Prms: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_Op_Ins_Crd_Prm_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      05000000120000002E000000490044005F00520057005F00540050005F004F00
      ...
      5F00530054004100540055005300010000000000}
  ...
  object Db_Ins_Crd_Per_Instrs: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_Per_Ins_Crd_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000001600000028000000490044005F00520057005F00540050005F005000
  ...
  object Db_Ins_Crd_Ins_Tmplts: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_P_Ins_Crd_Tmplts_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000001200000030000000490044005F00520057005F00540050005F004F00
  ...
  object Data_Ins_Crd_Ins_Tmplts: TDataSource
    ...
    OnDataChange = Data_Ins_Crd_Ins_TmpltsDataChange
    Left = 816
    Top = 352
  end
  ...
  object Db_Ins_Crd_Ins_Tmp_Prms: TOracleDataSet
    SQL.Strings = (
      ...
      '                And t.Rw_Status In ('#39'none_edit'#39')'
      #9#9'And Not Exists ( Select 1'
      #9#9#9#9' From   Ogt.V_Tp_Ok_P_Ins_Crd_Tmp_Prm_Vers a'
      #9#9#9#9' Where  a.Rw_Status In ('#39'updated'#39', '#39'deleted'#39')'
      #9#9#9#9'        And a.Doc_Tp_Id  In (:Id, :Parent_Id_Doc)'
    ...
    Variables.Data = {
      ...
      000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      050000001500000030000000490044005F00520057005F00540050005F005000
      ...
      530054004100540055005300010000000000}
