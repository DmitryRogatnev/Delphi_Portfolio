object Form17: TForm17
  ...
  object Content: TOracleDataSet
    SQL.Strings = (
      'select t.*,'
      '       (t.sz_cost * (t.sz_Nds/100)) Nds_Cost'
      'From   mrk.SZ_SEO_CONTENT t where t.sz_id = :sz_id'
      'order by t.id_str')
    Optimize = False
    Variables.Data = {
      04000000010000000C0000003A0053005A005F00490044000500000000000000
  ...
  object INFO_MAIN: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      010000000000180000005300540041005400550053005F00560041004C005500
      45000100000000001800000053005A005F0044004100540041005F0043004500
      4E005900010000000000}
    Session = Form20.OracleSession1
    Left = 160
    Top = 128
