object Form32: TForm32
  ...
  object DS_SIGN: TOracleDataSet
    SQL.Strings = (
      'select t.SIGNBMP, t.rowid from mrk.SZ_USERS t'
      'where Id = :sz_from_Y')
    Optimize = False
    Variables.Data = {
      0400000001000000140000003A0053005A005F00460052004F004D005F005900
      050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      05000000010000000E0000005300490047004E0042004D005000000000000000}
    Master = INFO_MAIN
    MasterFields = 'SZ_FROM_Y'
    Session = Form20.OracleSession1
    Left = 408
    Top = 128
    object DS_SIGNSIGNBMP: TBlobField
      FieldName = 'SIGNBMP'
      BlobType = ftOraBlob
    end
  end
  ...
  object INFO_MAIN: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
    ...
    object Page1: TfrxReportPage
      ...
      object Header4: TfrxHeader
        ...
        object frxDB_MAINSZ_ADD: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDB_MAIN."SZ_ADD"] [frxDB_MAIN."SZ_DATA_COST"]')
          ParentFont = False
          Formats = <
            item
            end
